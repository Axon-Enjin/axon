...
| ----- | ----- | ----- | ----- |
| **A1** | **V2 price list for quotations** — Core + modules + Offer 2/3 (Build + 12 mo care) | Old §6 numbers exist but are unquotable ([`FLAGS.md`](FLAGS.md) F-01/F-02/F-03). New list is for **quotes only** — see **F-34** (no pesos on the site). | Founder price list mapped to Offer 1–3 + modules; used in quote templates only |

...
**Website company tagline (D-2026-008):** *The one who connects.* — homepage H1. About teaches axon (axis / cable / signal) and enjin (engine / connector). Do **not** put “Agentic AI Systems,” Greek script, or neuron art on the H1. Product name: **Axlefield** (D-2026-009). Product sub: *Add the tools you need.* Lexicon: [`../BRAND.md`](../BRAND.md).

**Upwork / international channel tagline (D-2026-007):** *In-house developers. Without the hire.* — profile headline and first overview line only. Does **not** replace the product one-liner. Does **not** go on the website hero. Copy: [`../UPWORK.md`](../UPWORK.md).
...
**On the sites (two properties):**

- **Company** (`axonenjin.com`): collaborate section + footer only. **No** homepage CTA equal to Axlefield. **No** primary-nav “Ventures.”
- **Product** (`axlefield.axonenjin.com`): **never.** No collaboration topic on `/contact`.
...
| ----- | ----- | ----- | ----- |
| **A1** | **V2 price list for quotations** — Core + modules + Offer 2/3 (Build + 12 mo care) | Packaging shape locked (F-01–F-03 closed; D-2026-005 = quote V2 only). Pesos still **REQUIRES DECISION** (D-2026-006 Proposed). Quotes only — **F-34**. | Founder fills internal quote list and accepts D-2026-006; never publish pesos on this site |
